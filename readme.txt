...
Soundoff requires the python library prettytable which can be found here: https://code.google.com/p/prettytable/ (And it does indeed, make a very pretty table)